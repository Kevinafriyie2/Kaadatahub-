...
// New: Check if AFA product exists and has a price
if (!$product || $product->get_price() === '') {
    return '<div class="notice notice-error"><p>AFA registration product is not configured or does not have a price. Please contact an administrator.</p></div>';
}
