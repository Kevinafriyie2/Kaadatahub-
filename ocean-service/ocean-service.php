...
function osc_process_afa_registration(){
    ...
    $product_id = get_option('osc_afa_product_id');
    $price = get_option('osc_afa_registration_price', 15.00);
...
$current_price = get_option('osc_afa_registration_price', 15.00);
...
$current_status = get_option('osc_afa_order_status_default', 'completed');
?>
<div class="wrap">
